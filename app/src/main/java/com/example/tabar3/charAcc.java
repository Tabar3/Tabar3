...
public class charAcc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_char_acc);
    ...
    private void setFirebase() {
        ...
        Query query = fStore.collection("Charities").whereEqualTo("accept",false);
            ...
            itemAdapter.setOnItemClickListener(new ItemAdabter.ClickListener() {
                ...
                public void onItemClick(int position, View v, List<item> CharItems) {
                    ...
                    if (ItemC.getCharityName() != null) {
                        Intent intent = new Intent(charAcc.this, Charity_Info.class);
                        intent.putExtra("CharitiesInfo", ItemC.getCharityId());
                        startActivity(intent);


                    }else
                        Toast.makeText(charAcc.this,"Nooot Dooonee", Toast.LENGTH_SHORT).show();
                }
