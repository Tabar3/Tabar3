...
public class CharBooked extends AppCompatActivity {
    ...
    private void setViews() {
        mRecyclerView = findViewById(R.id.rVH1);
    ...
    private void setFirebase() {
        ...
        id = mAuth.getCurrentUser().getUid();
                ...
                query = fStore.collection("Charities").document(id).collection("category");
            ...
            CatAdabter.setOnItemClickListener(new ChategoryAdapter.ClickListener() {
                ...
                public void onItemClick(int position, View v, List<Cat_Item> Items) {
                    ...
                    if (ItemC.getDes() != null) {
                        Intent intent = new Intent(CharBooked.this, Cat_Info.class);
                        ...
                        Toast.makeText(CharBooked.this, "Nooot Dooonee", Toast.LENGTH_SHORT).show();
                }
